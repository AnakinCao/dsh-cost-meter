...
- **今日/会话费用**：价格**实时抓取自 DeepSeek 官方定价页**（`api-docs.deepseek.com/zh-cn/quick_start/pricing`，元/百万 token，1 小时刷新一次），官方改价自动跟随；抓取失败时回退内置价格（与官方当前一致）。自动按生效日期（2026-08-17 00:00 北京时间）与峰谷时段（北京 9-12、14-18 高峰）计价；
